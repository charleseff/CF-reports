...
public class Column
{
    ...
    public Object getValue(boolean decorated) throws ObjectLookupException, DecoratorException
    {
        ...
        else if (this.header.getBeanPropertyName() != null)
        {
            ...
            else if (this.row.getParentTable() != null &&
                    this.row.getParentTable().getTableDecorator() != null &&
                this.row.getParentTable().getTableDecorator() instanceof XQTableDecorator){
                    XQTableDecorator xqTableDecorator = (XQTableDecorator)this.row.getParentTable().getTableDecorator();
                    object = xqTableDecorator.retrieveValue(this.header.getBeanPropertyName());
